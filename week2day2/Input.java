...
public class Input {
	public static void main(String[] args) throws InterruptedException  {
		...
		driver.findElement(By.xpath("//h5[text()='Type email and Tab. Confirm control moved to next element.']/following::input[1]")).sendKeys("dhanasekaran@gmail.com",Keys.TAB);
		driver.findElement(By.xpath("//h5[text()='Type about yourself']/following::textarea")).sendKeys("im dhanasekaran");
		...
		driver.findElement(By.xpath("(//div[@style='height: 300px;']//p)[1]")).sendKeys("greetings");
		...
		WebElement Label = driver.findElement(By.xpath("//label[text()='Username']"));
		if(label != Label) {
			System.out.println("Label changes");
		}else {
			System.out.println("Label not changes");
		}
		driver.findElement(By.xpath("//h5[text()='Type your name and choose the third option']/following::input[@aria-autocomplete='list']")).sendKeys("dhanasekaran");
		driver.findElement(By.xpath("//li[contains(@data-item-label,'2')]")).click();
		driver.findElement(By.xpath("//h5[text()='Type your DOB (mm/dd/yyyy) and confirm date chosen ']/following::input[contains(@id,'input')][1]")).sendKeys("24/05/2002");
		driver.findElement(By.xpath("//a[text()='2']")).click();
		driver.findElement(By.xpath("//h5[text()='Type number and spin to confirm value changed']/following::input[contains(@id,'input')][1]")).sendKeys("3");
		...
		driver.findElement(By.xpath("//h5[text()='Type random number (1-100) and confirm slider moves correctly']/following::input[contains(@id,'slider')]")).sendKeys("3");
		...
		driver.findElement(By.xpath("//h5[text()='Custom Toolbar']/following::div[@data-placeholder='Enter your content']")).sendKeys("something");
		Thread.sleep(1000);
